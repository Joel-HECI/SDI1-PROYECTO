...
HD_PWD='C:/Users/electronica.ECINUT/Downloads/SDI1-PROYECTO-main/SDI1-PROYECTO-main/JOUSAMRON MICROONDAS/JOUSAMRON MICROONDAS.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mainT.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mainT.tcl
