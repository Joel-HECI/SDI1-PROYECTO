...
HD_PWD='C:/Users/electronica.ECINUT/Downloads/SDI1-PROYECTO-main/SDI1-PROYECTO-main/JOUSAMRON MICROONDAS/JOUSAMRON MICROONDAS.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mainT.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mainT.tcl -notrace
